  ...
  return (
    <>
      ...
      <div className="section_0">
          <div className="section_4_text" ><p><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24"><path fill="#012E57" d="m10 18l-6-6l6-6l1.4 1.45L7.85 11H20v2H7.85l3.55 3.55L10 18Z"/></svg>View Patient</p> </div>
        </div>
